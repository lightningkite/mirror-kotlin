...
data class SatisfiesExampleSecondMirror<T: Any?>(
    ...
    companion object : MirrorClassCompanion {
        ...
        override val minimal = SatisfiesExampleSecondMirror(TypeArgumentMirrorType("T", Variance.INVARIANT, TMirrorMinimal))
