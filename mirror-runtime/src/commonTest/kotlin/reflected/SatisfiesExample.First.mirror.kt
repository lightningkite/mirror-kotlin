...
data class SatisfiesExampleFirstMirror<T: Any?>(
    ...
    companion object : MirrorClassCompanion {
        ...
        override val minimal = SatisfiesExampleFirstMirror(TypeArgumentMirrorType("T", Variance.INVARIANT, TMirrorMinimal))
