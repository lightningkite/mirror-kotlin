...
class TripleMirror<A : Any?, B : Any?, C : Any?>(
    ...
    companion object {
        val minimal = TripleMirror(AnyMirror.nullable, AnyMirror.nullable, AnyMirror.nullable)
    }

    override val typeParameters: Array<MirrorType<*>> get() = arrayOf(AMirror, BMirror, CMirror)
    @Suppress("UNCHECKED_CAST")
    override val kClass: KClass<Triple<A, B, C>>
        get() = Triple::class as KClass<Triple<A, B, C>>
